...
public class registrarMatriculaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        matriculaC1 = new Matricula(idAlumno, nombreCurso, creditosCurso, cicloCurso);
        ...
        matriculaC2 = new Matricula(idAlumno, nombreCurso, creditosCurso, cicloCurso);
        ...
        matriculaC3 = new Matricula(idAlumno, nombreCurso, creditosCurso, cicloCurso);
        ...
        matriculaC4 = new Matricula(idAlumno, nombreCurso, creditosCurso, cicloCurso);
